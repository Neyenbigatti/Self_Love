...
const facialExplorationConfig: Record<string, unknown> = {
  sections: [
      ...
      fields: [
        {
          ...
          required: true,
          sortOrder: 1, isActive: true, system: true,
        },
        {
          key: 'phototype',
          label: 'Fototipo',
          ...
          required: true,
          sortOrder: 2, isActive: true, system: true,
        },
      ],
    },
    {
      ...
      fields: [
        { key: 'flacidity', label: '¿Flacidez?', type: 'boolean', sortOrder: 1, isActive: true, system: true },
        { key: 'expressionLines', label: '¿Líneas de expresión?', type: 'boolean', sortOrder: 2, isActive: true, system: true },
        { key: 'nevi', label: '¿Nevos?', type: 'boolean', sortOrder: 3, isActive: true, system: true },
        { key: 'neviLocation', label: '¿Dónde?', type: 'text', sortOrder: 4, isActive: true, system: true },
        { key: 'macules', label: '¿Máculas?', type: 'boolean', sortOrder: 5, isActive: true, system: true },
        { key: 'maculeCount', label: '¿Cuántas?', type: 'number', sortOrder: 6, isActive: true, system: true },
        { key: 'maculeLocation', label: '¿Dónde?', type: 'text', sortOrder: 7, isActive: true, system: true },
        { key: 'telangiectasias', label: '¿Telangiectasias?', type: 'boolean', sortOrder: 8, isActive: true, system: true },
        { key: 'telangiectasiasLocation', label: '¿Dónde?', type: 'text', sortOrder: 9, isActive: true, system: true },
        { key: 'rosacea', label: '¿Rosácea?', type: 'boolean', sortOrder: 10, isActive: true, system: true },
        { key: 'acne', label: '¿Acné?', type: 'boolean', sortOrder: 11, isActive: true, system: true },
        { key: 'acneGrade', label: '¿Qué grado?', type: 'text', sortOrder: 12, isActive: true, system: true },
        { key: 'darkCircles', label: '¿Ojeras?', type: 'boolean', sortOrder: 13, isActive: true, system: true },
        { key: 'darkCirclesType', label: '¿Qué tipo?', type: 'text', sortOrder: 14, isActive: true, system: true },
        { key: 'edema', label: '¿Edema?', type: 'boolean', sortOrder: 15, isActive: true, system: true },
        { key: 'edemaLocation', label: '¿Dónde?', type: 'text', sortOrder: 16, isActive: true, system: true },
      ],
    },
    {
      ...
      title: 'Antecedentes',
      fields: [
        { key: 'hasHadTreatment', label: '¿Se ha realizado algún tratamiento facial?', type: 'boolean', sortOrder: 1, isActive: true, system: true },
        { key: 'treatmentType', label: '¿Qué tipo de tratamiento?', type: 'text', sortOrder: 2, isActive: true, system: true },
        { key: 'hasRoutine', label: '¿Tiene una rutina facial?', type: 'boolean', sortOrder: 3, isActive: true, system: true },
        { key: 'routineProducts', label: '¿Qué utiliza?', type: 'text', sortOrder: 4, isActive: true, system: true },
      ],
    },
    {
      id: 'sun-exposure',
      ...
      fields: [
        { key: 'sunExposure', label: '¿Toma sol o cama solar?', type: 'boolean', sortOrder: 1, isActive: true, system: true },
        { key: 'burnsEasily', label: '¿Se quema fácilmente?', type: 'boolean', sortOrder: 2, isActive: true, system: true },
      ],
    },
    {
      ...
      fields: [
        { key: 'motive', label: 'Motivo de consulta', type: 'textarea', required: true, sortOrder: 1, isActive: true, system: true },
      ],
    },
    {
      ...
      fields: [
        { key: 'clinicalJudgment', label: 'Juicio de valor', type: 'textarea', sortOrder: 1, isActive: true, system: true },
      ],
    },
    {
      id: 'goals',
    ...
    },
    {
      ...
      title: 'Derivaciones',
      fields: [
        { key: 'referrals', label: 'Derivaciones', type: 'textarea', sortOrder: 1, isActive: true, system: true },
      ],
    },
    {
      id: 'additional-notes',
      ...
      fields: [
        { key: 'additionalNotes', label: 'Otras observaciones', type: 'textarea', sortOrder: 1, isActive: true, system: true },
      ],
    },
  ],
  widgets: {
