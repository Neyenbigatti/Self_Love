...
/**
 * Generate an inline HTML email for email verification.
 */
...
<body>
  <div class="container">
    ...
    <p>Gracias por registrarte en SelfLove. Hacé clic en el botón de abajo para verificar tu dirección de email:</p>
    ...
    <p style="font-size:13px;color:#888;">Este enlace expira en 24 horas. Si no creaste una cuenta en SelfLove, podés ignorar este mensaje.</p>
